...
(function() {
    ...
    DIViewer.DetailFacet = (function() {
        ...
        function DetailFacet(option) {
            ...
            for(var i=_visibleHeaderIndexStart; i<=_visibleHeaderIndexEnd; i++){
                _selectedCollums.push(i);
            }
        ...
        DetailFacet.prototype.scrollToHere = function(specifiedIndex){
            if(jQuery.inArray(specifiedIndex, _selectedCollums) !== -1){//exist
                //remove from array
                _selectedCollums = jQuery.grep(_selectedCollums, function(value) {
                    return value != specifiedIndex;
                });
            }else{
                _selectedCollums.push(specifiedIndex);
                _selectedCollums.sort();
            }
        ...
        DetailFacet.prototype.initHeaderEvent = function () {
            if(_scrollableHeaders){

                var that = this;
                _scrollableHeaders.forEach(function (sHeader){
                    $('#'+sHeader.indicator).bind('click', function (e) {
        ...
        DetailFacet.prototype.resetHeader = function () {
            if(_scrollableHeaders){
                ...
                var that = this;
                _scrollableHeaders.forEach(function (sHeader){
                    if(jQuery.inArray(sHeader.index, _selectedCollums) !== -1){
