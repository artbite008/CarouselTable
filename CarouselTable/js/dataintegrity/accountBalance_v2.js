...
var _url_2weeks = '/views/dataintegrity/data/acctbalance/v2/fixed_range_2_weeks?';
var _url_dynamic_range = '/views/dataintegrity/data/acctbalance/v2/dynamic_range?';
...
$(document).ready(function() {
    ...
    _detailFacet = DIViewer.DetailFacet({
        ...
        pageSize: 10,
        queryURL: '/views/dataintegrity/data/acctbalance/v2/reconmatrix?',
        queryByIdURL: '/views/dataintegrity/data/acctbalance/v2/reconmatrix/',
        exportURL: '/views/dataintegrity/data/acctbalance/v2/reconmatrix/export?',
        columnDefs: [
            {
                targets: 0,
