    ...
    var factory = function( $, DataTable ) {
        ...
        ColVis.prototype = {
            ...
            "_fnConstruct": function ( init ) {
                ...
                //     })
                //     .appendTo(div1)[0];
                // this.dom.wrapper.append(div1);

                if (window.dataTableOptions && window.dataTableOptions.showExportButton) {
                    var div2 = document.createElement('div');
                    var button2 = $('<a />', {
                        'id': 'export_link',
                        'click': function(){_detailFacet.export();},
                        'class': !this.s.dt.bJUI ?
                            "ColVis_Button ColVis_MasterButton btn btn-default btn-xs" :
                            "ColVis_Button ColVis_MasterButton ui-button ui-state-default"
                    })
                        .append('&nbsp;Export&nbsp;')
                        .appendTo(div2)[0];
                    this.dom.wrapper.append(div2);
                }
            ...
            "_fnDomColumnButton": function ( i )
            {
                ...
                return $(
                    ...
                    '<label>'+
                    '<input type="checkbox"/>'+
                    '<span>'+title.replace("br", "").replace("<>", "")+'</span>'+
                    '</label>'+
                    '</li>'
                )
                    .click( function (e) {
